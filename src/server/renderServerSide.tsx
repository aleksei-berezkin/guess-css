...
import { APP_PLACEHOLDER, SCRIPT_PLACEHOLDER, STYLE_PLACEHOLDER } from '../../templateConst';
import { PRELOADED_STATE_ID } from '../client/redux/preloadedStateId';
    ...
    const app = renderToString(
        sheets.collect(
            <Provider store={ createAppStore(state) }>
                <PuzzlerApp staticRoute={ req.path }/>
            </Provider>
        )
    );
